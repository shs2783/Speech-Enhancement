...
if __name__ == '__main__':
    win_size = 512  # 16000Hz * 0.032s (=32ms) in paper
    hop_size = 256  # 16000Hz * 0.016s (=16ms) in paper
    fft_size = 512

    signal = torch.randn(1, 32000)

    # model = CARN(window_size, hop_size, fft_size, lstm_channels=512)
    model = GCARN(win_size, hop_size, fft_size, lstm_channels=512)
